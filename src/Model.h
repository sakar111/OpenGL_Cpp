...
Material loadMaterial(aiMaterial* mat) {
    ...
    //std::cout << glm::to_string(material.Ambient) << std::endl << glm::to_string(material.Diffuse) << std::endl << glm::to_string(material.Specular) << std::endl << material.Shininess << std::endl << std::endl << std::endl;
